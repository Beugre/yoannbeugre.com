  ...
  return (
    <section id="trade" className="relative py-20 px-4">
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        {/* RESULT — chart stays visible on top, result below */}
        {phase === "result" && (
          <div style={{ background: "rgba(10,10,15,0.98)", border: `1px solid ${won ? "rgba(16,185,129,0.3)" : "rgba(239,68,68,0.25)"}`, borderRadius: 16, overflow: "hidden" }}>
            {/* Chart stays visible */}
            <div style={{ padding: "6px 14px 2px", background: "rgba(6,6,10,0.9)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 2px 4px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  <div style={{ width: 28, height: 28, borderRadius: 6, background: "#f0b90b", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, fontWeight: 900, color: "#000" }}>₿</div>
                  <span style={{ fontSize: 12, fontWeight: 700, color: "rgba(255,255,255,0.7)" }}>BTC/USDT · {timeframe}</span>
                </div>
                <div style={{ fontFamily: "monospace", fontSize: 12, color: gs.actualPct >= 0 ? "#10b981" : "#ef4444", fontWeight: 700 }}>
                  {gs.actualPct >= 0 ? "▲ UP" : "▼ DOWN"} {gs.actualPct >= 0 ? "+" : ""}{(gs.actualPct * 100).toFixed(3)}%
                </div>
              </div>
              <Chart candles={gs.candles} winIdx={gs.winIdx} replayN={REPLAY_N} showReplay animKey={animKey + 100} />
            </div>
            ...
            <div style={{ padding: "16px 20px" }}>
              <div style={{ textAlign: "center", marginBottom: 14 }}>
                ...
                <div style={{ fontSize: 22, fontWeight: 900, color: won ? "#10b981" : "#ef4444" }}>{won ? "YOU WERE RIGHT !" : "YOU WERE WRONG"}</div>
              </div>
